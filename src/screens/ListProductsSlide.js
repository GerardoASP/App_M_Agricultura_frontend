...
const ListProductsSlide = () => {
  ...
  return (
    <View style={{flex:0, justifyContent:"center", alignItems:"center", alignContent:"center"}}>
        <Text style={{fontWeight: 'bold', fontSize: 24, marginTop: 260, fontFamily: 'San Francisco', fontFamily: 'Roboto',}}>Mis productos</Text>
        <Card style={{marginTop:80}}>
            ...
            <Card.Cover source={{ uri: 'https://img.freepik.com/vector-gratis/dibujos-animados-zanahoria-naranja-aislado_1308-127216.jpg' }} />
            <Card.Actions>
